 ...
 * @author erdem
 */
public class NewInsert extends javax.swing.JFrame {
    public ResultSet rs;
    public Statement st;
    EmployeeUI gu=new EmployeeUI();
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(layout.createSequentialGroup()
                        ...
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addComponent(TitleArea, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.PREFERRED_SIZE, 200, javax.swing.GroupLayout.PREFERRED_SIZE)))
    ...
    private void jButton1MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jButton1MouseClicked
        try {
            st=gu.baglantiAc();
            st.executeUpdate("Insert into Employee(FirstName,LastName,Email,Department,Title)Values('"+FirstNameArea.getText()+"','"+LastNameArea.getText()+"','"+EmailArea.getText()+"','"+DepartmentArea.getText()+"','"+TitleArea.getText()+"')");
            close();    
        } 
        catch (Exception ex) {
             JOptionPane.showMessageDialog(null, "This people have already registered!");
        }
    }//GEN-LAST:event_jButton1MouseClicked
    //Jframe kapatmak için kullandığım close metodu 
    public void close(){
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new NewInsert().setVisible(false);
            }
        });
    }
